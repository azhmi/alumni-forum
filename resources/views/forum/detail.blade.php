        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <hr>
                    <div class="row">
                        <form method="post" action="/forum/detail/komen/save">
                        @csrf
                        <div  class="col-md-12">
                            <p class="text">Tanggapan Anda : </p>
                            <div class="form-group">
                            <input type="hidden" name="komforid" value="{{ $forum[0]->forid }}">
                                <textarea name="komis" id="foris" rows="3" placeholder="Content..." class="form-control"></textarea>
                            </div>
                    ...
                    <div class="row">
                        ...
                        @foreach($komen as $k)
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="card-text"><?php echo $k->komis ?>
                                    </p>
                                    <div class="table-data-feature">
                                    <form method="POST" action="/komen/delete/{{$k->komid}}">
                                        
                                        @if (Route::has('login'))
                                            @if (Auth::check())
                                            @if(Auth::user()->level==$k->level)
                                        
                                        <a class="item" href="/forum/detail/{{$forum[0]->forid}}/edit/{{$k->komid}}"  data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
