...
@section('content')
    <section class="statistic statistic2">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="title-4">Perbarui Pertanyaan, Pernyataan, atau Diskusi.</h1>
                    <hr>    
                    <form method="post" action="/forum/edit/{{$forum->forid}}/save" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <label for="cc-name" class="control-label mb-1">Judul Forum</label>
                                        ...
                                        <input type="text" id="text-input" name="forjud" value="{{$forum->forjud}}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    <label for="cc-name" class="control-label mb-1">Isi forum</label>
                            
                                        <textarea name="foris" id="textarea-input" rows="3" placeholder="Content..." class="form-control">{{$forum->foris}}"</textarea>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <p>Gambar</p>
                            <small class="form-text text-muted">Jika memperbarui gambar</small>
                            <div class="card">
